...
if __name__ == "__main__":
    ...
    dx = rademacher_vector(batch_size, num_directions, 5)
    # dx = torch.randn(batch_size, num_directions, 5)
    ...
    for i in range(num_directions):
        primal, dual = torch.autograd.functional.jvp(forward_fn, x, dx[:, i])
    ...
    # model2 = CustomCrossEntropyLoss(reduction='none')
